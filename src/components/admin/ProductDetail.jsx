    ...
    return (
        <div>
            <div className="py-5 flex justify-between items-center">
                {/* text  */}
                <h1 className=" text-xl text-pink-300 font-bold">All Services</h1>
                {/* Add Services Button  */}
                <Link to={'/addproduct'}>
                    <button className="px-5 py-2 bg-blue-50 border border-blue-100 rounded-lg">Add Services</button>
                </Link>
            </div>
