...
const CartPage = () => {
    ...
    const calculateTotalAmount = () => {
        // Calculate total amount by adding cartTotal and tipAmount
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="py-4 px-2 border-t border-gray-200">
                                    <h3 className="text-lg font-medium mb-2">Tip</h3>
                                    <div className="flex items-center justify-between space-x-4">
                                        {[
                                            ...
                                            <button
                                                key={index}
                                                onClick={() => handleTipSelection(option.amount)}
                                                className={`px-3 py-1 rounded-md border ${tipAmount === option.amount ? 'bg-gray-200' : 'bg-white'
                                                    }`}
                                            >
                                                {option.label}
                                            </button>
                                ...
                                <div className="flex items-center justify-between border-t border-dashed py-4">
                                    <dt className="text-base font-medium text-gray-900">Total Amount (including tip)</dt>
                                    <dd className="text-base font-medium text-gray-900">₹ {calculateTotalAmount()}</dd>
                                </div>
                                <p className="mt-8 text-sm text-gray-500">
                                    **Prices may vary for any additional service taken by the customer from the provider.**
                                </p>
